...
public class panel_fight : Panel_Base
{
    ...
    public override void Initialize()
    {
        ...
        player_battle_attack_prefabs= Battle_Tool.Find_Prefabs<GameObject>("player_battle_attck_item"); //Resources.Load<GameObject>("Prefabs/panel_fight/player_battle_attck_item");
        monster_battle_attack_prefabs = Battle_Tool.Find_Prefabs<GameObject>("monster_battle_attck_item"); //Resources.Load<GameObject>("Prefabs/panel_fight/monster_battle_attck_item");
