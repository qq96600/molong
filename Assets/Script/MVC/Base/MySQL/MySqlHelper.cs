...
{
    //获取数据库connectionstring，它是静态变量，只读，所有项目文档都可以直接使用，但不能修改
    ...
    //the database connectionString 数据库连接字符串
    ...
    //This connectionString for the local test 本地测试
    ...
    public static readonly string connectionStringManager = "MySQLConnString";
    ...
    //以前，这个方法可以用lock方法来锁定表，不允许别人这样做修改时间它已读取然后解锁表。
    ...
    /// <param name="commandParameters">提供列表中使用的参数数组</param>
